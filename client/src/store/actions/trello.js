...
export const updateTrelloItemStart = ({ _id, updateTitle }) => {
  return { type: type.UPDATE_TRELLO_ITEM_START, payload: { _id, updateTitle } }
}
...
export const deleteTrelloItemStart = ({ _id, confirmTitle }) => {
  return { type: type.DELETE_TRELLO_ITEM_START, params: { _id, confirmTitle } }
}

export const deleteTrelloItemSuccess = (_id) => {
  return { type: type.DELETE_TRELLO_ITEM_SUCCESS, _id }
}

export const updateCardItem = ({ destination, source, draggableId }) => {
  return { type: type.UPDATE_CARD_ITEM, payload: { destination, source, draggableId } }
}
