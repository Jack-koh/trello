...
export const UPDATE_BOARD_ITEM_START = 'board/UPDATE_BOARD_ITEM_START';
export const UPDATE_BOARD_ITEM_SUCCESS = 'board/UPDATE_BOARD_ITEM_SUCCESS';
...
export const DRAG_TRELLO_ITEM_END = 'trello/DRAG_TRELLO_ITEM_END';
...
export const UPDATE_CARD_START = 'card/UPDATE_CARD_START';
export const DRAG_CARD_END = 'card/DRAG_CARD_END';
export const DELETE_CARD_ITEM_START = 'card/DELETE_CARD_ITEM_START';
export const DELETE_CARD_ITEM_SUCCESS = 'card/DELETE_CARD_ITEM_SUCCESS';
